...
import { RiVideoLine, RiLiveLine, RiSearchLine, RiCloseLine, RiUploadCloudLine } from "react-icons/ri"
...
const DiscoverVideos = () => {
  ...
  useEffect(() => {
    if (!user) {
      navigate('/login')
      toast.info('Please login to access videos')
    }
  }, [user, navigate])
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredVideos.length > 0 ? (
            ...
            <div className="col-span-full text-center py-12">
              ...
              <Button asChild className="mt-4 bg-purple-500 hover:bg-purple-600 text-white">
                <Link to="/video/upload" className="flex items-center gap-2">
                  <RiUploadCloudLine className="text-lg" />
